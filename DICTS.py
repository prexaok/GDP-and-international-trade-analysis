DROPS_DICT = {'drop_1':['Channel Islands', 'Djibouti', 'Faroe Islands', 'Gibraltar', 'Not classified', 'St. Martin (French part)', 'Korea, Dem. People’s Rep.', 'South Sudan', 
'Sint Maarten (Dutch part)', 'Turks and Caicos Islands', 'British Virgin Islands', 'World', 'Upper middle income', 'Sub-Saharan Africa (IDA & IBRD countries)', 
'South Asia (IDA & IBRD)', 'Middle East & North Africa (IDA & IBRD countries)', 'Latin America & the Caribbean (IDA & IBRD countries)', 
'Europe & Central Asia (IDA & IBRD countries)', 'East Asia & Pacific (IDA & IBRD countries)', 'Small states', 'Sub-Saharan Africa', 
'Sub-Saharan Africa (excluding high income)', 'South Asia', 'Post-demographic dividend', 'Pacific island small states', 
'Pre-demographic dividend', 'Other small states', 'OECD members', 'North America', 'Middle East & North Africa (excluding high income)', 'Middle East & North Africa', 'Middle income',
'Late-demographic dividend', 'Low & middle income', 'Lower middle income', 'Least developed countries: UN classification', 'Latin America & Caribbean',
'Latin America & Caribbean (excluding high income)', 'IDA only', 'IDA blend', 'IDA total', 'IDA & IBRD total', 'IBRD only', 'Heavily indebted poor countries (HIPC)',
'High income', 'Fragile and conflict affected situations', 'European Union', 'Europe & Central Asia', 'Europe & Central Asia (excluding high income)', 'East Asia & Pacific', 
'Early-demographic dividend', 'East Asia & Pacific (excluding high income)', 'Central Europe and the Baltics', 'Euro area', 'Low income', 'Arab World'],
'drop_2':['Gibraltar', 'Not classified', 'St. Martin (French part)', 'Korea, Dem. People’s Rep.', 'South Sudan', 
'Sint Maarten (Dutch part)', 'British Virgin Islands', 'World', 'Upper middle income', 'Sub-Saharan Africa (IDA & IBRD countries)', 
'South Asia (IDA & IBRD)', 'Middle East & North Africa (IDA & IBRD countries)', 'Latin America & the Caribbean (IDA & IBRD countries)', 
'Europe & Central Asia (IDA & IBRD countries)', 'East Asia & Pacific (IDA & IBRD countries)', 'Small states', 'Sub-Saharan Africa', 
'Sub-Saharan Africa (excluding high income)', 'South Asia', 'Post-demographic dividend', 'Pacific island small states', 
'Pre-demographic dividend', 'Other small states', 'OECD members', 'North America', 'Middle East & North Africa (excluding high income)', 'Middle East & North Africa', 'Middle income',
...
'Latin America & Caribbean (excluding high income)', 'IDA only', 'IDA blend', 'IDA total', 'IDA & IBRD total', 'IBRD only', 'Heavily indebted poor countries (HIPC)',
'High income', 'Fragile and conflict affected situations', 'European Union', 'Europe & Central Asia', 'Europe & Central Asia (excluding high income)', 'East Asia & Pacific', 
'Early-demographic dividend', 'East Asia & Pacific (excluding high income)', 'Central Europe and the Baltics', 'Euro area', 'Low income', 'Arab World', 'Cayman Islands', 'Curacao', 
'Channel Islands']}



GROUP_DICT = {'south_america':['year', 'Argentina', 'Bolivia', 'Brazil', 'Chile', 'Colombia', 'Ecuador', 'Peru', 'Paraguay', 'Uruguay', 'Venezuela, RB', 'Guyana', 'Suriname'],
'latin_america': ['year', 'Argentina', 'Bolivia', 'Chile', 'Colombia', 'Ecuador', 'Peru', 'Paraguay', 'Uruguay', 'Venezuela, RB', 'Costa Rica', 'Cuba', 'Dominican Republic', 'Guatemala', 'Honduras','Mexico',
'Nicaragua', 'Panama', 'Puerto Rico', 'El Salvador'],
'north_america':['year', 'United States', 'Canada', 'Mexico'],
'caribe': ['Greenland', 'Cuba', 'Bahamas, The', 'Costa Rica', 'Dominican Republic', 'Panama', 'Jamaica', 'Guatemala', 'Haiti',
'Bermuda', 'Belize', 'Aruba', 'El Salvador', 'Barbados', 'Honduras', 'Nicaragua', 'Curacao', 'Cayman Islands', 'St. Lucia', 'Grenada', 'Dominica', 'Antigua and Barbuda',
'Virgin Islands (U.S.)'],
'mercosur':['Brazil', 'Argentina', 'Uruguay', 'Paraguay', 'Bolivia'],
'g20': ['Germany', 'Saudi Arabia', 'Argentina', 'Australia', 'Brazil', 'Canada', 'China', 'France', 'India', 'Indonesia', 'Italy', 'Japan', 'Mexico', 'Russian Federation',
'South Africa', 'Korea, Rep.', 'Turkey', 'United States', 'United Kingdom']}


places = {'United Arab Emirates': ('23.424076', '53.847818'),
